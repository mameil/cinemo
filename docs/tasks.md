...
- [ ] `collectIndieScreenings()` 오케스트레이터 작성 후 기존 `schedule-all.ts`의 `INDIE` stage로 연결
- [ ] 씨네큐브 공식 날짜별 시간표 수집 (현재 인스타 특별상영 8회차만 임시 적재)
- [ ] 에무시네마 공식 홈페이지/Dtryx 시간표 수집
- [ ] 필름포럼 공식 홈페이지 시간표 수집
- [ ] 인디스페이스 공식 예매/시간표 수집
- [ ] 아트하우스 모모 공식 예매/시간표 수집
- [ ] 서울아트시네마 공식 프로그램 시간표 수집
- [ ] 더숲 아트시네마 공식 예매/시간표 수집
- [ ] 아리랑시네센터 공식 홈페이지 시간표 수집
